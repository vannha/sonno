...
function spyropress_ui_toggle( $item, $id, $value, $is_widget = false, $is_builder = false ) {
    ...
    printf( '<div class="toggle_set%1$s">', ( isset( $item['toggle_class'] ) ) ? ' ' . esc_attr( $item['toggle_class'] ) : '' );
        print '<div ' . build_section_class( 'section-subheading toggle_trigger', $item ) . '>';
